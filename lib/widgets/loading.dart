...
const double LOADING_SIZE = 50;

class AppLoading extends StatelessWidget {
  const AppLoading({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) => const Center(child: LoadingWidget());
}
...
class LoadingWidget extends StatefulWidget {
  ...
  const LoadingWidget({
    Key? key,
    this.color1 = const Color(0xFF4286f5),
    this.color2 = const Color(0xFFea4235),
    this.color3 = const Color(0xFFfbbc05),
  }) : super(key: key);
...
class _LoadingWidgetState extends State<LoadingWidget>
  ...
  void initState() {
    ...
    animation1 = Tween<double>(begin: 0, end: 1).animate(
        CurvedAnimation(parent: controller1, curve: const Interval(0, 1)));
